...
-- Drop ALL existing policies on whatsapp_codes (using exact names from database)
...
DROP POLICY IF EXISTS "whatsapp_codes_deny_all_users" ON public.whatsapp_codes;
...
CREATE POLICY "secure_whatsapp_codes_service_only" 
...
CREATE POLICY "secure_whatsapp_codes_deny_users" 
ON public.whatsapp_codes 
FOR ALL 
